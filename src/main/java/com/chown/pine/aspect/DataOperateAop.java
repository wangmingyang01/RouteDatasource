...
public class DataOperateAop
{
	 ...
	 * 数据查询切面
	 */
	@Before ("execution(* com.chown.pine.db.dao..*.get*(..)) || execution(* com.chown.pine.db.dao..*.query*(..))")
	 ...
	 * 数据写切面
	 */
	@Before ("execution(* com.chown.pine.db.dao..*.add*(..)) || execution(* com.chown.pine.db.dao..*.update*(..))"
			+ "|| execution(* com.chown.pine.db.dao..*.del*(..))")
